...
export const priceCategories: PriceCategory[] = [
  ...
  },
  {
    id: "haircuts",
    label: "Haircuts",
    subtitle: "Precision, Every Time",
    image: "/images/spick-and-span/category-haircut.jpg",
    imageAlt: "A stylist giving a precision haircut at Spick & Span Beauty Studio",
    items: [
      { name: "Trim", description: "Maintain the shape you already love.", duration: "30 mins", price: "₦8,000" },
      { name: "Classic Cut", description: "A clean, considered cut.", duration: "45 mins", price: "₦12,000" },
      { name: "Precision Cut", description: "Sharp lines, exact finish.", duration: "60 mins", price: "₦18,000" },
      { name: "Fade", description: "Crisp blend, sharp edges.", duration: "45 mins", price: "₦15,000" },
      { name: "Kids Cut", description: "Patient, gentle, quick.", duration: "30 mins", price: "₦6,000" },
    ],
  },
  {
    id: "nails",
  ...
  },
  {
    id: "mani-pedi",
    label: "Mani-Pedi",
    subtitle: "Hands & Feet, Together",
    image: "/images/spick-and-span/service-mani-pedi.jpeg",
    imageAlt: "A combined manicure and pedicure session at Spick & Span Beauty Studio",
    items: [
      { name: "Classic Mani-Pedi Combo", description: "The full, unhurried treatment.", duration: "90 mins", price: "₦18,000" },
      { name: "Gel Mani-Pedi Combo", description: "Glossy finish, hands and feet.", duration: "100 mins", price: "₦25,000" },
      { name: "Luxury Spa Mani-Pedi", description: "The complete, slow version.", duration: "120 mins", price: "₦35,000" },
    ],
  },
  {
    id: "pedicure",
